...
class JavaSymbolCache(SymbolCache[dict, cache_value | None]):
    def __init__(self):
        ...
        self.compilation_unit_to_cache_keys: dict[
            compilation_unit_fqn, set[cache_key]
        ] = {}

    def get(
        self, compilation_unit_fqn: compilation_unit_fqn, symbol_name: symbol_name
    ) -> cache_value | None:
    ...
    def set(
        self,
        compilation_unit_fqn: compilation_unit_fqn,
    ...
    def clear_compilation_unit(
        self, compilation_unit_fqn: compilation_unit_fqn
    ) -> None:
